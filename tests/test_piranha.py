...
def test_piranha_rewrite():
    args = PiranhaArguments(
        path_to_configurations="crates/core/test-resources/java/feature_flag_system_1/treated/configurations",
        language="java",
        substitutions={
        ...
        paths_to_codebase=["crates/core/test-resources/java/feature_flag_system_1/treated/input"],
        dry_run=True,
    )
    ...
    expected_paths = [
        "crates/core/test-resources/java/feature_flag_system_1/treated/input/XPFlagCleanerPositiveCases.java",
        "crates/core/test-resources/java/feature_flag_system_1/treated/input/TestEnum.java",
    ]
    ...
    assert is_as_expected(
        "crates/core/test-resources/java/feature_flag_system_1/treated", output_summaries
    )
...
def test_piranha_rewrite_custom():
    ...
    args = PiranhaArguments(
        language="java",
        paths_to_codebase=["crates/core/test-resources/java/custom_rules/input"],
        path_to_custom_builtin_rules="crates/core/test-resources/java/custom_rules/custom_rules",
    ...
    expected_paths = [
        "crates/core/test-resources/java/custom_rules/input/Sample.java",
    ]
    assert all([o.path in expected_paths for o in output_summaries])
    summary: PiranhaOutputSummary
    for summary in output_summaries:
    ...
    assert is_as_expected(
        "crates/core/test-resources/java/custom_rules/", output_summaries
    )
...
def test_piranha_match_only():
    args = PiranhaArguments(
        path_to_configurations="crates/core/test-resources/java/structural_find_with_include_exclude/configurations",
        language="java",
        paths_to_codebase=["crates/core/test-resources/java/structural_find_with_include_exclude/input"],
        dry_run=True,
        exclude=["*/folder_2_1/**/*"]
    )
    output_summaries = execute_piranha(args)
...
""",
    ...
    args = PiranhaArguments(
        paths_to_codebase=["crates/core/test-resources/java/insert_field_and_import/input"],
        language="java",
    ...
    output_summaries = execute_piranha(args)
    assert is_as_expected(
        "crates/core/test-resources/java/insert_field_and_initializer/", output_summaries
    )
...
def test_delete_unused_field():
    ...
    args = PiranhaArguments(
        paths_to_codebase=["crates/core/test-resources/java/delete_unused_field/input"],
        language="java",
        rule_graph = rule_graph,
        dry_run=True,
    )
    ...
    assert is_as_expected(
        "crates/core/test-resources/java/delete_unused_field/", output_summaries
    )
...
def test_delete_comments_preserved():
    ...
    args = PiranhaArguments(
        language="java",
        paths_to_codebase=["crates/core/test-resources/java/delete_comments/input"],
    ...
    assert is_as_expected("crates/core/test-resources/java/delete_comments/", output_summaries)
